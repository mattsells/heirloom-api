...
ActiveRecord::Schema.define(version: 2021_08_06_195300) do
  ...
  create_table "recipe_stories", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["recipe_id"], name: "index_recipe_stories_on_recipe_id"
    t.index ["story_id"], name: "index_recipe_stories_on_story_id"
  end
  ...
  add_foreign_key "recipe_stories", "recipes"
  add_foreign_key "recipe_stories", "stories"
